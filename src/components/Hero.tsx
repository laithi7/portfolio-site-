      ...
      <div className="relative mx-auto max-w-4xl px-6 md:px-10 lg:px-16">
        <div className="flex flex-col items-center gap-8 md:flex-row md:items-center md:gap-8">
          ...
          <Reveal className="relative w-[130px] shrink-0 md:w-[150px]">
            {hasGreeting && (
              <div className="absolute -top-8 start-1/2 flex -translate-x-1/2 items-center justify-center gap-2 whitespace-nowrap font-heading text-sm text-white/90 rtl:translate-x-1/2 md:start-0 md:translate-x-0 md:rtl:translate-x-0 md:justify-start">
